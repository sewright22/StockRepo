...
{
    public class BasicStochasticOscillatorPredictorAlgorithmUsingFlipCriteria : ISimulation
    {
        private int _dVal;
        private int _kVal;
        private StockDbAccess _repo;

        public BasicStochasticOscillatorPredictorAlgorithmUsingFlipCriteria(int kVal, int dVal)
        {
        ...
        public void Run()
        {
            ...
            foreach(var stock in stockList)
            {
                ...
                IBuySellCriteria crit5 = new BasicThresholdBuySellFlipCriteria(runID5, 5, stochasticOscillator);
                IBuySellCriteria crit10 = new BasicThresholdBuySellFlipCriteria(runID10, 10, stochasticOscillator);
                IBuySellCriteria crit15 = new BasicThresholdBuySellFlipCriteria(runID15, 15, stochasticOscillator);
                IBuySellCriteria crit20 = new BasicThresholdBuySellFlipCriteria(runID20, 20, stochasticOscillator);
